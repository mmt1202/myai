...
3. 增加 lifecycle API endpoint 或数据库 run store。
4. 增加 provider-specific billing/invoice reconciliation。
...
1. P1：继续实现 provider-native bidirectional continuation adapter、distributed quota backend、lifecycle API endpoint、secret-gated provider smoke profiles。
