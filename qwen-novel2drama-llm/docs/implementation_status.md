...
- `docs/p1_agent_runtime.md`：Agent runtime、lifecycle API 与 continuation contract 说明。
...
- `docs/p1_api_server_integration.md`：API server 集成与 Agent lifecycle API 说明。
...
1. P1：继续实现数据库 run store、provider-native bidirectional continuation adapter、distributed quota backend、secret-gated provider smoke profiles。
