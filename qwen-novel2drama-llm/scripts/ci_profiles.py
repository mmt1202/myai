...
PROFILES: dict[str, CIProfile] = {
    ...
    "provider-adapter": CIProfile(
        ...
        tests=("tests.test_provider_adapter_contract", "tests.test_provider_factory", "tests.test_provider_continuation", "tests.test_openai_responses_provider"),
    ),
    "provider-smoke": CIProfile(
        ...
        tests=("tests.test_provider_smoke_config", "tests.test_openai_responses_smoke"),
    ),
