...
2. 增加 Agent streaming run events 与 resume/cancel/retry。
...
1. P1：继续实现本地 provider 流式、Agent streaming events、CI contract check、workspace-level budget/quota。
